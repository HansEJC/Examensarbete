										...
										<div class="6u">
											<section class="box">
												<form>
														...
														<div id="manhast" hidden>
															Hastighet [cm/s]:<br>
															<input type="text" name="pendel" value="40"><br></div>
														<div id="autoslap">
															Sjuta/Släppa kula [s]:<br>
															<input type="text" name="kula" value="3"><br></div>
												</form>
											</section>
										...
										<div class="6u" id="auto">
											<section class="box">
												<form onsubmit="return send()">
													...
													<input onmousedown="send()" name="ok" type="submit" value="Kör">
													<?php      
													//	$Hastighet_status = 'unchecked';
														//$Acceleration_status = 'unchecked';
														if(isset($_GET['ok'])){
															...
															fwrite($myfile, $dst);											
															fwrite($myfile, " & sudo python /home/pi/wiringPi/WiringPi2-Python/drv8835-motor-driver-rpi/csvwriter.py ");										fwrite($myfile, $txt);fwrite($myfile, " ");
															fwrite($myfile, $dst);	
															fclose($myfile);
															}					
															...
															fwrite($myfile1, "sudo python /home/pi/wiringPi/WiringPi2-Python/drv8835-motor-driver-rpi/acceleration.py ");										fwrite($myfile1, $txt);fwrite($myfile1, " ");
															fwrite($myfile1, $dst);											
															fwrite($myfile1, " & sudo python /home/pi/wiringPi/WiringPi2-Python/drv8835-motor-driver-rpi/csvwriteracc.py ");										fwrite($myfile1, $txt);fwrite($myfile1, " ");
															fwrite($myfile1, $dst);									
															fclose($myfile1);
															}
														}else   
